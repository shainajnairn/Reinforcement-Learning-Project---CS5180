...
class PPO:
    def __init__(
        ...
        action_std_init=0.6,
        mini_batch_size=64,  # <--- Argument for mini-batch size
        lam=0.95,  # <--- Argument for GAE
    ):
    ...
    def update(self):
        """
        PPO update using GAE(\lambda) for advantage estimation.
        Returns the average GAe return over the update batch.
        """
        ...
        for _ in range(self.K_epochs):
            ...
            # Compute the probability ratio (pi_theta / pi_theta_old)
            ...
            # Final loss: clipped surrogate + value loss - entropy bonus
            loss = (
        ...
        # Compute and return the average GAe return
        avg_gae_return = returns.mean().item()
        return avg_gae_return
